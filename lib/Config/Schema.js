...
class Schema {
   ...
   *
   * @throws {Errors.ConfigValidationError}             If an invalid (non-object) parameter has been passed
   * @throws {Errors.ConfigValidationMissingFieldError} If a required field is missing
   * @throws {Errors.ConfigValidationInvalidFieldError} If a field is unknown
   * @throws {Errors.ConfigValidationTypeError}         If a values type doesn't match the requirements
   * @throws {Errors.ConfigValidationValidatorError}    If a field validator can't validate a field
   */
  validate ( obj ) {
   ...
   *
   * @throws {Errors.ConfigValidationInvalidFieldError} If the field is unknown
   * @throws {Errors.ConfigValidationTypeError}         If the values type doesn't match the requirements
   * @throws {Errors.ConfigValidationValidatorError}    If the field validator can't validate the field
   */
