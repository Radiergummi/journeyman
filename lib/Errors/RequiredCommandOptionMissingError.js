 ...
 * @memberof Errors
 */
class RequiredCommandOptionMissingError extends JourneymanError {
  ...
  constructor ( command, option, input ) {
    super( `Option "${option.longName || option.shortName}" is missing but declared as required` );
...
module.exports = RequiredCommandOptionMissingError;
