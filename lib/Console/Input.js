...
const RequiredCommandOptionMissingError      = require( '../Errors/RequiredCommandOptionMissingError' );
const RequiredCommandArgumentMissingError    = require( '../Errors/RequiredCommandArgumentMissingError' );
const RequiredCommandOptionValueMissingError = require( '../Errors/RequiredCommandOptionValueMissingError' );
  ...
  validate ( command ) {
    ...
    command.getArguments().forEach( ( argument, index ) => {
      ...
      if ( argument.isRequired() ) {
        throw new RequiredCommandArgumentMissingError( command, argument, this );
      }
    } );
    ...
    for ( let optionDefinition of command.getOptions() ) {
      ...
      if ( this.hasOption( optionDefinition ) ) {
        ...
        if ( optionDefinition.isValueRequired() && typeof optionValue === 'undefined' ) {
          throw new RequiredCommandOptionValueMissingError( command, optionDefinition, this );
        }
        ...
        if ( optionDefinition.isRequired() ) {
          throw new RequiredCommandOptionMissingError( command, optionDefinition, this );
        }
